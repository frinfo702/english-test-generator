...
```json
{
  "sentences": [
    {
      "id": "s1",
      "chunks": ["has significantly", "Remote work", "the traditional", "changed", "office model"],
      "correctOrder": [1, 0, 3, 2, 4],
      "fullSentence": "Remote work has significantly changed the traditional office model"
    },
    {
      "id": "s2",
      "chunks": ["to reduce", "Governments worldwide", "are implementing", "carbon emissions", "new policies"],
